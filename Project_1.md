...
| 3    |Meeting client's representative Dr.Ruben to discuss possible additions and changes to the program| Having all the information needed in order to start working on the program |  25min        | Sep 29                 | A |    
